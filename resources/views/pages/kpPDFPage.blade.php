            ...
            <div class="head-bg-pdf">
                <table class="head-table">
                    <tr>
                        ...
                        <td>
                            <div class="last">
                                <p class="mb-0 text-white"><img class="svg-icon mx-2" src="{{ asset('images/svg/envelope-regular.svg') }}" alt="phone">+7(495)003-45-62</p>
                                <p class="mb-0 text-white"><img class="svg-icon mx-2" src="{{ asset('images/svg/envelope-regular.svg') }}" alt="email">zapros@aronasb.ru</p>
                            </div>
                        </td>
                    </tr>
                </table>
            </div>
            <div class="head-bg-bottom align-items-center">
                <table>
                    <tr>
                        <td>
