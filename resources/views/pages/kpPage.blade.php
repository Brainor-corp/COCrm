            ...
            <div class="row head-bg">
                ...
                <div class="col-4 mt-3">
                    <div class="col-12 float-right">
                        <p class="mb-0 text-white h4 text-right float-right"><img class="svg-icon mx-2" src="{{ asset('images/svg/phone-solid.svg') }}" alt="phone">{{ $offersGroup->user->tel ?? '+7(495)003-45-62' }}</p>
                    </div>
                    <div class="float-right">
                        <p class="mb-0 text-white h4 text-right"><img class="svg-icon mx-2" src="{{ asset('images/svg/envelope-regular.svg') }}" alt="email">{{ $offersGroup->user->contact_email ?? 'zapros@aronasb.ru' }}</p>
                    </div>
                </div>
            </div>
